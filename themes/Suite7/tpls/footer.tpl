...
<footer>
    ...
    <div id="dialogSugar" title="&copy; {$MOD.LBL_SUITE_POWERED_BY}">
        ...
        <a id="admin_optionss">&copy; Supercharged by Atomic Solutions</a>
        <a id="powered_bys">&copy; Powered By Atomic Solutions</a>
    </div>
...
function qe_init(){
    ...
    //   all existing listeners.  This will prevent adding multiple listeners per element and firing multiple events per click
