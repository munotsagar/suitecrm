...
$hook_array['before_save'][] = Array(1, 'Custom Products tier 5 hidden field save',
    'custom/modules/AOS_Products/productsHookClass.php','ProductsHookClass', 'SaveTierHiddenField'); /*
