 ...
 *
 * Atomic Solutions is an extension to SugarCRM Community Edition developed by SalesAgility Ltd.
 ...
 * SugarCRM" logo and "Supercharged by Atomic Solutions" logo. If the display of the logos is not
 * reasonably feasible for technical reasons, the Appropriate Legal Notices must
 * display the words "Powered by SugarCRM" and "Supercharged by Atomic Solutions".
 */
...
$mod_strings = array(
    ...
    'ERR_CREDENTIALS_MISSING' => 'Your Atomic Solutions credentials are missing.',
    ...
    'ERROR_VERSION_INCOMPATIBLE' => 'The uploaded file is not compatible with this version of Atomic Solutions: ',
    'HDR_LOGIN_PANEL' => 'Please enter your Atomic Solutions Login credentials.',
    'HEARTBEAT_MESSAGE' => "<BR>The Atomic Solutions Updates mechanism allows your server to check to see if an update for your version of Atomic Solutions is available.",
    ...
    'LBL_BACKUP_DIRECTORY_WRITABLE' => 'Must be writable by Atomic Solutions',
    ...
    'LBL_BACKUP_INSTRUCTIONS_1' => 'The purpose of this tool is to assist in creating backups of the Atomic Solutions application files. (Database backups should also be performed regularly. Please refer to your database vendor\'s documentation for information on how to backup your database.)',
    'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your Atomic Solutions application files in a .zip file, enter the following information:',
    'LBL_BACKUP_RUN_BACKUP' => 'Run Backup',
    'LBL_BACKUPS_TITLE' => 'Backups',
    'LBL_BACKUPS' => 'Backup Atomic Solutions files',
    'LBL_BUG_TITLE' => 'Bugs',
    ...
    'LBL_COULD_NOT_CONNECT' => 'Error: Could not connect to the Atomic Solutions Server.
    ...
    'LBL_DIAGNOSTIC_CONFIGPHP' => 'Atomic Solutions config.php',
    'LBL_DIAGNOSTIC_CUSTOMDIR' => 'Atomic Solutions Custom directory',
    ...
    'LBL_DIAGNOSTIC_GETSUGARLOG' => 'Getting Atomic Solutions.log',
    ...
    'LBL_DIAGNOSTIC_SUGARLOG' => 'Atomic Solutions Log File',
    'LBL_DIAGNOSTIC_TITLE' => 'Diagnostic Tool',
    'LBL_DIAGNOSTIC_VARDEFS' => 'Atomic Solutions schema output (VARDEFS)',
    ...
    'LBL_LDAP_HELP_TXT' => 'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the Atomic Solutions Password Management feature settings will apply.',
    ...
    'LBL_LDAP_GROUP_NAME_DESC' => 'Example cn=Atomic Solutions',
    'LBL_LDAP_USER_DN_DESC' => 'Example: ou=people,dc=example,dc=com',
    'LBL_LDAP_AUTO_CREATE_USERS_DESC' => 'If an authenticated user does not exist, one will be created in Atomic Solutions.',
    ...
    'LBL_MI_IN_DASHLETS' => 'Installing Atomic Solutions Dashlet ',
    'LBL_MI_UN_DASHLETS' => 'Uninstalling Atomic Solutions Dashlet ',
    ...
    'LBL_MODULE_LOADER' => 'Add or remove Atomic Solutions modules, themes, language packs and other extensions',
    ...
    'LBL_PROXY_ON_DESC' => 'Use a proxy to access external information such as Atomic Solutions updates.',
    ...
    'LBL_REBUILD_DASHLETS_DESC_SHORT' => 'Rebuilds the Atomic Solutions Dashlets cache file',
    'LBL_REBUILD_DASHLETS_DESC_SUCCESS' => 'Atomic Solutions Dashlets cache file rebuilt.',
    'LBL_REBUILD_DASHLETS_DESC' => 'Removing Atomic Solutions Dashlets cache and scanning known directories for Atomic Solutions Dashlet files.',
    'LBL_REBUILD_DASHLETS_TITLE' => 'Rebuild Atomic Solutions Dashlets',
    ...
    'LBL_RETURN' => 'Return',
    'LBL_SEND_STAT' => '<B>Send Anonymous Usage Statistics</B> - If checked, it will send anonymous statistics about your installation to Atomic Solutions. every time your system checks for new versions. This information will help us better understand how the application is used and guide improvements to the product.',
    ...
    'LBL_SUGAR_UPDATE_TITLE' => 'Atomic Solutions Updates',
    'LBL_SUGARCRM_HELP' => 'Atomic Solutions Help',
    'LBL_SUPPORT_TITLE' => 'Atomic Solutions Support Portal',
    ...
    'LBL_UPDATE_TITLE' => 'Atomic Solutions Updates',
    'LBL_UPGRADE_TITLE' => 'Repair',
    'LBL_UPGRADE_WIZARD_TITLE' => 'Upgrade Wizard',
    'LBL_UPGRADE_WIZARD' => 'Upload and install Atomic Solutions upgrades',
    'LBL_UPGRADE' => 'Check and repair Atomic Solutions',
    ...
    'LBL_USERS_DESC' => 'Create, edit, activate and deactivate users in Atomic Solutions.',
    ...
    'LBL_MODULEBUILDER_DESC' => 'Build new modules to expand the functionality of Atomic Solutions',
    'LBL_SUGARPORTAL' => 'Atomic Solutions Portal',
    ...
    'LBL_QUICK_REPAIR_AND_REBUILD_DESC' => 'Repairs and rebuilds DB, Extensions, Vardefs, Atomic Solutions Dashlets etc.',
    ...
    'LBL_QR_CBOX_CLEARDASHLET' => 'Clear Atomic Solutions Dashlet Cache Data',
    ...
    'LBL_QR_CLEARDASHLET' => 'Clearing Atomic Solutions Dashlet files from cache...done',
    ...
    'LBL_QR_CBOX_CLEARSUGARFEEDCACHE' => 'Clear Atomic Solutions Feed Cache',
    'LBL_QR_CLEARSUGARFEEDCACHE' => 'Clearing Atomic Solutions Feed Cache...done',
    ...
    'ML_RELAX_LOCAL' => 'If you are running Atomic Solutions locally, you can relax your Module Loader restrictions to allow the package to be installed.',
    'ML_SUGAR_KB' => 'Atomic Solutions Knowledge Base',
    'ML_SUGAR_DZ' => 'Atomic Solutions Developer Zone',
    'ML_AVAIL_RESTRICTION' => 'The available restrictions and exceptions are detailed in the',
    'ML_OVERRIDE_CORE_FILES' => 'Overriding of core Atomic Solutions files is not allowed ',
    ...
    'LBL_SAML_HELP_TXT' => 'When SAML authentication is enabled, passwords can only be handled through SAML. None of the Atomic Solutions Password Management feature settings will apply.',
